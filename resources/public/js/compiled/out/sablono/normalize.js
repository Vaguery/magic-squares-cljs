...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__28023){
var vec__28024 = p__28023;
var _ = cljs.core.nth.call(null,vec__28024,(0),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__28027_SHARP_){
return ((p1__28027_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__28027_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__28029,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__28029;
}
});
...
var len__27818__auto___28032 = arguments.length;
var i__27819__auto___28033 = (0);
while(true){
if((i__27819__auto___28033 < len__27818__auto___28032)){
args__27825__auto__.push((arguments[i__27819__auto___28033]));

var G__28034 = (i__27819__auto___28033 + (1));
i__27819__auto___28033 = G__28034;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__27826__auto__);
});
...
var G__28031 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__28031,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__28031;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq28030){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28030));
});
...
var vec__28040 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__28040,(0),null);
var names = cljs.core.nth.call(null,vec__28040,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__28040,tag_name,names){
return (function (p1__28035_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__28035_SHARP_))){
return p1__28035_SHARP_;
} else {
return null;
}
});})(matches,vec__28040,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__28040,tag_name,names){
return (function (p1__28036_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__28036_SHARP_));
});})(matches,vec__28040,tag_name,names))
...
return cljs.core.remove.call(null,cljs.core.nil_QMARK_,(((x == null))?cljs.core.List.EMPTY:((typeof x === 'string')?(function (){var x__27547__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__27547__auto__);
})():(cljs.core.truth_(sablono.util.element_QMARK_.call(null,x))?(function (){var x__27547__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__27547__auto__);
})():(((cljs.core.list_QMARK_.call(null,x)) && ((cljs.core.first.call(null,x) instanceof cljs.core.Symbol)))?(function (){var x__27547__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__27547__auto__);
})():((cljs.core.list_QMARK_.call(null,x))?x:(((cljs.core.sequential_QMARK_.call(null,x)) && (cljs.core._EQ_.call(null,cljs.core.count.call(null,x),(1))) && (cljs.core.sequential_QMARK_.call(null,cljs.core.first.call(null,x))) && (!(typeof cljs.core.first.call(null,x) === 'string')) && (cljs.core.not.call(null,sablono.util.element_QMARK_.call(null,cljs.core.first.call(null,x)))))?sablono.normalize.children.call(null,cljs.core.first.call(null,x)):((cljs.core.sequential_QMARK_.call(null,x))?x:(function (){var x__27547__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__27547__auto__);
})()
))))))));
});
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__28043){
var vec__28050 = p__28043;
...
var tag = first__28052;
var content = seq__28051__$1;
...
var vec__28053 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__28053,(0),null);
var id = cljs.core.nth.call(null,vec__28053,(1),null);
var class$ = cljs.core.nth.call(null,vec__28053,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1496186904062