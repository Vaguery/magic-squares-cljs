...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__33256){
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__33260_SHARP_){
return ((p1__33260_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__33260_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__33262,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__33262;
}
});
...
var len__27557__auto___33265 = arguments.length;
var i__27558__auto___33266 = (0);
while(true){
if((i__27558__auto___33266 < len__27557__auto___33265)){
args__27564__auto__.push((arguments[i__27558__auto___33266]));

var G__33267 = (i__27558__auto___33266 + (1));
i__27558__auto___33266 = G__33267;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__27565__auto__);
});
...
var G__33264 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__33264,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__33264;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq33263){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33263));
});
...
var tag_name = cljs.core.nth.call(null,vec__33273,(0),null);
var names = cljs.core.nth.call(null,vec__33273,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__33273,tag_name,names){
return (function (p1__33268_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__33268_SHARP_))){
return p1__33268_SHARP_;
} else {
return null;
}
});})(matches,vec__33273,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__33273,tag_name,names){
return (function (p1__33269_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__33269_SHARP_));
});})(matches,vec__33273,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__33276){
var vec__33283 = p__33276;
...
var tag = first__33285;
var content = seq__33284__$1;
...
var vec__33286 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__33286,(0),null);
var id = cljs.core.nth.call(null,vec__33286,(1),null);
var class$ = cljs.core.nth.call(null,vec__33286,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1496186257706